...
@class Kotlin_multiplat_platform_exampleUser, Kotlin_multiplat_platform_exampleGithubApiClientImpl, Kotlin_multiplat_platform_exampleApiClient, Kotlin_multiplat_platform_exampleKotlinx_coroutines_coreCoroutineDispatcher, Kotlin_multiplat_platform_exampleKotlinAbstractCoroutineContextElement, Kotlin_multiplat_platform_exampleKotlinArray, Kotlin_multiplat_platform_exampleKotlinx_serialization_runtimeSerialKind, Kotlin_multiplat_platform_exampleKotlinNothing, Kotlin_multiplat_platform_exampleKotlinx_serialization_runtimeUpdateMode, Kotlin_multiplat_platform_exampleKotlinEnum;

@protocol Kotlin_multiplat_platform_exampleKotlinCoroutineContext, Kotlin_multiplat_platform_exampleKotlinx_coroutines_coreCoroutineScope, Kotlin_multiplat_platform_exampleAppDispatchers, Kotlin_multiplat_platform_exampleGithubApiClient, Kotlin_multiplat_platform_exampleKotlinx_serialization_runtimeKSerializer, Kotlin_multiplat_platform_exampleKotlinCoroutineContextElement, Kotlin_multiplat_platform_exampleKotlinCoroutineContextKey, Kotlin_multiplat_platform_exampleKotlinx_serialization_runtimeEncoder, Kotlin_multiplat_platform_exampleKotlinx_serialization_runtimeSerialDescriptor, Kotlin_multiplat_platform_exampleKotlinx_serialization_runtimeSerializationStrategy, Kotlin_multiplat_platform_exampleKotlinx_serialization_runtimeDecoder, Kotlin_multiplat_platform_exampleKotlinx_serialization_runtimeDeserializationStrategy, Kotlin_multiplat_platform_exampleKotlinContinuation, Kotlin_multiplat_platform_exampleKotlinContinuationInterceptor, Kotlin_multiplat_platform_exampleKotlinx_coroutines_coreRunnable, Kotlin_multiplat_platform_exampleKotlinx_serialization_runtimeCompositeEncoder, Kotlin_multiplat_platform_exampleKotlinx_serialization_runtimeSerialModule, Kotlin_multiplat_platform_exampleKotlinAnnotation, Kotlin_multiplat_platform_exampleKotlinx_serialization_runtimeCompositeDecoder, Kotlin_multiplat_platform_exampleKotlinIterator, Kotlin_multiplat_platform_exampleKotlinx_serialization_runtimeSerialModuleCollector, Kotlin_multiplat_platform_exampleKotlinKClass, Kotlin_multiplat_platform_exampleKotlinComparable, Kotlin_multiplat_platform_exampleKotlinKDeclarationContainer, Kotlin_multiplat_platform_exampleKotlinKAnnotatedElement, Kotlin_multiplat_platform_exampleKotlinKClassifier;
...
@property (readonly) id<Kotlin_multiplat_platform_exampleKotlinCoroutineContext> coroutineContext __attribute__((swift_name("coroutineContext")));
@property (readonly) Kotlin_multiplat_platform_exampleGithubApiClientImpl *githubApiClient __attribute__((swift_name("githubApiClient")));
@end;
...
@interface Kotlin_multiplat_platform_exampleAppDispatchersImpl : KotlinBase <Kotlin_multiplat_platform_exampleAppDispatchers>
